...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CategorieRepository' => function () {
...
}, 'App\\Repository\\ReponseRepository' => function () {
    return ($this->privates['App\Repository\ReponseRepository'] ?? $this->load('getReponseRepositoryService.php'));
